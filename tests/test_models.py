...
# ── 被测模块 ──────────────────────────────────────────────────────────────────
from models import build_model, clone_teacher_to_student, get_block_names
from models.compensators import (
    # AdapterCompensator,
    AffineCompensator,
    IdentityCompensator,
...
from models.injector import (
    InjectedModel,
    PatchedBlock,
    inject,
    resnet_block_specs,
)
from models.origin.resnet import BasicBlock, Bottleneck, build_resnet
